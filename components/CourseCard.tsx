...
export const CourseCard: React.FC<CourseCardProps> = ({ 
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col transition-all hover:shadow-md ${isDisabled ? 'opacity-50 grayscale' : ''}`}>
      ...
      <div className="p-4 flex-1 flex flex-col">
        <div className="flex justify-between items-start mb-2">
          ...
          {isCompleted && <CheckCircle size={18} className="text-green-500 shrink-0 ml-2" />}
        </div>
        ...
        <div className="mt-auto space-y-3">
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-3">
             ...
             <div className="flex items-center gap-2">
                ...
                {course.isDownloaded ? (
                  <button 
                    onClick={(e) => { e.stopPropagation(); onRemoveDownload(course.id); }}
                  ...
                  <button 
                    onClick={(e) => { e.stopPropagation(); onDownload(course.id); }}
